...
import { LayoutDashboard, User, MapPin, Package, Flame, LogOut } from 'lucide-react'
import { cn } from '@/lib/utils'
import { useAuthStore } from '@/stores/authStore'

const navItems = [
  { href: '/seller/dashboard', label: 'Accueil',  icon: LayoutDashboard },
  { href: '/seller/profile',   label: 'Profil',   icon: User },
  { href: '/seller/location',  label: 'Position', icon: MapPin },
